                        ...
                        <div class="row row-grid">
                            <div class="col-lg-4">
                                <card class="border-0" hover shadow body-classes="py-5">
                                    ...
                                    <p class="description mt-3">Lorem ipsul dolor sit amet consecutar
                                      consecutar
                                        Lorem ipsul dolor dolor sit amet consecutar consecutar.</p>
                                    <base-button tag="a" href="/blog" type="primary" class="mt-4">
                                        Learn more
                                    </base-button>
                                </card>
                            </div>
                            <div class="col-lg-4">
                                <card class="border-0" hover shadow body-classes="py-5">
                                    ...
                                    <h6 class="text-success text-uppercase">Design Patterns</h6>
                                    <p class="description mt-3">Lorem ipsul dolor sit amet consecutar
                                      consecutar
                                        Lorem ipsul dolor dolor sit amet consecutar consecutar.</p>
                                    <base-button tag="a" href="/patterns" type="success" class="mt-4">
                                        Learn more
                                    </base-button>
                                </card>
                            </div>
                            <div class="col-lg-4">
                                <card class="border-0" hover shadow body-classes="py-5">
                                    ...
                                    <h6 class="text-warning text-uppercase">Future Events</h6>
                                    <p class="description mt-3">Lorem ipsul dolor sit amet consecutar
                                      consecutar
                                        Lorem ipsul dolor dolor sit amet consecutar consecutar.</p>
                                    <base-button tag="a" href="/events" type="warning" class="mt-4">
                                        Learn more
                                    </base-button>
                                </card>
                            </div>
                ...
                <div class="row row-grid align-items-center">
                    ...
                    <div class="col-lg-6 order-lg-1">
                        <div class="d-flex px-3">
                            ...
                            <div class="pl-4">
                                <h4 class="display-3 text-white">How Can I <strong>SaaS</strong> on AWS?</h4>
